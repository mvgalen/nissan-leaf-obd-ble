...
leaf_commands = {
    ...
    "unknown":               OBDCommand("unknown",               "Mystery command",              b"0210C0",      0,  unknown,                header=b"797",fast=True),
...
#    "lbc":                   OBDCommand("lbc",                   "Li-ion battery controller",    b"0300000000000000",      53, lbc,                    header=b"79B",),
}
# fmt: on
